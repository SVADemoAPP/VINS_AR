...
public class MoniPointShape extends Shape{
    ...
    Bitmap bitmap;
    public MoniPointShape(Object tag, int coverColor,Context context,String content)
    {
        ...
        imageView.setImageResource(R.drawable.moni);
