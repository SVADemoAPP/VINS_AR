...
public class CollectPointShape extends Shape{
    ...
    Bitmap bitmap;
    public CollectPointShape(Object tag, int coverColor,Context context,String content)
    {
        ...
        imageView.setImageResource(R.drawable.collect_shape);
