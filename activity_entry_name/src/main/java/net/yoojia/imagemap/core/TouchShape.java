...
public class TouchShape extends Shape
{
    ...
    Bitmap bitmap;
    public TouchShape(Object tag, int coverColor, View view, Context context)
    {
    ...
    public void draw(Canvas canvas)
    {
        ...
        canvas.drawBitmap(bitmap, f.x - bitmap.getWidth() / 2, f.y
